...
def f_z_regularizer_global(f):
    regu_diag = 0.0
    regu_offdiag = 0.0
    weights = f.fc1._layer.weight
    kappa_1 = 0.1
    kappa_2 = 1.0
    rho = 0.5 # contarction rate
...
odesavefolder = '/home/mzakwan/neurips2023/MNIST/global_cnodemodels/dense_resnet_final'
...
for itr in range(10 * batches_per_epoch):
    ...
    if SODEF:
        ...
        regu1_r = f_z_regularizer_global(odefunc)
        regu1_r = regu1_r.mean()
        regu3 = f_regularizer(odefunc, y00)
        regu3 = regu3.mean()
        loss =   weight_diag * torch.exp(regu1_r)   +  weight_f * regu3
