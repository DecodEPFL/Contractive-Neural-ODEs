...
class ODEBlock2(nn.Module):
    ...
    def ode_propagation(self,x0):
        traj_x  = odeint(self.odefunc, x0, self.time, method='rk4', atol=args.tol, rtol=args.tol)
...
feature_layers = [ODEBlock2(odefunc)] 
...
accuracy = accuracy_FGSM(classifier, testloader)
