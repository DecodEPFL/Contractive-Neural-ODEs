...
def get_args():
    ...
    parser.add_argument("--run_name", type=str, default="linear_node_test")
...
if __name__ == "__main__":
    ...
    checkpoint_callback = ModelCheckpoint(dirpath='./neurips2023/MNIST/Test_exp',
                                         filename='MNIST_cnode_orth_{epoch}',
                                         save_top_k=-1,
                                         every_n_epochs=1
        )
    ...
    trainer.save_checkpoint(
            "./neurips2023/MNIST/EXP-Global/resnetfinal/"+args.run_name+"_lightning_model.ckpt")
    time.sleep(5)
