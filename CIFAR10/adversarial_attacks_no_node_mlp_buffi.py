from phase2_no_node_mlp import ImageClassifier_CIFAR_global_no_node
...
str_reg_suf = './neurips2023/CIFAR10/EXP_No_node_mlp/orthogonal_no_node_mlp_lightning_model.ckpt'
ODE_FCmodel = ImageClassifier_CIFAR_global_no_node.load_from_checkpoint(str_reg_suf)
