...
from phase2_resnet_local import ImageClassifier_CIFAR_global
...
str_reg_suf = './neurips2023/CIFAR10/EXP_RESNET/wangresent_orthogonal_loca4_lightning_model.ckpt' 
